...
(29, '0000000', 1, 1, 5, 20000, 1, 20000, 'Samabalnya jangan kebnayakan', 1, 1),
(30, '0000000', 4, 1, 3, 20000, 1, 20000, '', 1, 1);
...
--
ALTER TABLE `order_list`
  MODIFY `id_order_list` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
